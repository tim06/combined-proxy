...
//	if extState == nil {
//		log.Printf("platformInterfaceWrapper.ReadWIFIState: external WIFIState is nil, returning default value")
//		extState = &WIFIState{SSID: "", BSSID: ""}
//	}
...
//}
//
//func safeStart(bs *singbox.BoxService) (err error) {
//	defer func() {
//		if r := recover(); r != nil {
//			log.Printf("panic in BoxService.Start: %v\n%s", r, debug.Stack())
//			err = fmt.Errorf("panic in BoxService.Start: %v", r)
//		}
//	}()
//	return bs.Start()
//}
