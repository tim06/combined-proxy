...
func (a *routePrefixIteratorAdapter) Next() *RoutePrefix {
    ...
    return mapRoutePrefix(libPrefix)
}
...
func (a *combinedNetworkInterfaceIteratorAdapter) Next() *singbox.NetworkInterface {
    ni := a.it.Next()
    return convertCombinedNetworkInterfaceToSingbox(ni)
}
...
func (c *CombinedExchangeContext) ErrorCode(code int32) {
